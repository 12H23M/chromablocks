...
### 2026-03-27 01:35 (commit 6f71cea)

**Quick Wins Implemented:**
1. ✅ StyleBoxFlat cache in board_renderer._draw()
2. ✅ Rounded rect polygon cache in DrawUtils
...
- Consider shader-based effects for further optimization
